...
public class PropertiesFile {
    ...
    private static final String propertiesFilePathRoot = "/resources/";
//            "src/test/resources/configs.properties";
    ...
    public static void setPropertiesFile(String FileName) {
        ...
        try {
            ...
            fileIn = new FileInputStream(projectPath + propertiesFilePathRoot + FileName);
            //Load properties file
            properties.load(fileIn);
        } catch (Exception exp) {
            Log.info(exp.getMessage());
            Log.info(exp.getCause());
            exp.printStackTrace();
        }
    }
